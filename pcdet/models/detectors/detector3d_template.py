...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'bev_shape', 'vfe', 'backbone_3d', 'map_to_bev_module', 'backbone_2d', 'dense_head', 'roi_head'
        ]
    ...
    def build_networks(self):
        model_info_dict = {
            ...
            'pillar_grid_size': self.dataset.pillar_grid_size,
            'point_cloud_range': self.dataset.point_cloud_range,
            'voxel_size': self.dataset.voxel_size,
            'pillar_voxel_size': self.dataset.pillar_voxel_size,
    ...
    def build_vfe(self, model_info_dict, type=None):
        if type == "bev_shape":
            ...
            vfe_module = vfe.__all__[model_cfg.VFE.NAME](
                ...
                voxel_size=model_info_dict['pillar_voxel_size'],
                grid_size=model_info_dict['pillar_grid_size'],
