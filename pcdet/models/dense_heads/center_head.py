...
class CenterHead(nn.Module):
    ...
    def get_loss_center(self):
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            target_boxes_centers = target_dicts['target_boxes'][idx][:, :, 0:3]
            pred_centers = pred_dict['center']
            pred_center_z = pred_dict['center_z']
    ...
    def generate_predicted_boxes(self, batch_size, pred_dicts):
        if self.training == False:
            post_process_cfg = self.model_cfg.TEST_POST_PROCESSING
        else:
    ...
    def generate_predicted_centers(self, batch_size, pred_dicts):
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            final_pred_center_dicts = centernet_utils.decode_centers_from_heatmap(
                heatmap=batch_hm, center=batch_center, center_z=batch_center_z,
    ...
    def forward(self, data_dict):
        ...
        if (
                not self.training or self.predict_boxes_when_training) and self.model_cfg.POST_PROCESSING.GENERATE_CENTERS != True:
        ...
        if self.model_cfg.POST_PROCESSING.GENERATE_CENTERS:
            ...
            data_dict['final_centers'] = pred_centers
        return data_dict
