...
class DatasetTemplate(torch_data.Dataset):
    def __init__(self, dataset_cfg=None, class_names=None, training=True, root_path=None, logger=None):
        ...
        self.pillar_grid_size = getattr(self.data_processor, 'pillar_grid_size', None)
        self.pillar_voxel_size = getattr(self.data_processor, 'pillar_voxel_size', None)
        ...
        for key, val in data_dict.items():
            try:
                if key in ['occ_voxels', 'occ_voxel_num_points', 'occ_voxel_points_label',
                           ...
                           'pillar_voxels', 'pillar_voxel_num_points',
                    ...
                    ret[key] = np.concatenate(val, axis=0)
                             ...
                             'voxel_coords', 'pillar_voxel_coords']:
                    coors = []
